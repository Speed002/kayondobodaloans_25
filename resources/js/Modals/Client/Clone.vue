...
<template>
    <Modal class="bg-nav-blue max-w-md p-12 font-mono">
        ...
        <form class="mt-6 space-y-6" v-on:submit.prevent="cloneClient">
            <p class="text-sm">Enter a new registration number to clone. <br>Please note that you can edit other client details later on the client profile!</p>
            <div>
                <input type="hidden" v-model="form.id">
                <input type="text" id="name" class="w-full py-2 text-gray-300 border-gray-300 text-sm" v-model="form.registration" placeholder="eg., UFH O44K">
