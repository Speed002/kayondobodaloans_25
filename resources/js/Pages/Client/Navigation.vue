...
<template>
    <div class="relative w-fit md:mb-6">
        ...
        <div class="portal relative rounded-md flex flex-col items-center space-y-1 bg-nav-blue p-4 shadow-lg">
            <span id="clone" class="absolute top-1 right-1 bg-cyan-950 text-white md:text-sm text-xs hover:cursor-pointer p-1 rounded-md">
                <DocumentDuplicateIcon class="h-4 w-4"/>
            </span>
            <span id="clone" class="absolute top-7 right-1 bg-cyan-950 text-white md:text-sm text-xs px-2 rounded-md">
            9
            </span>
            <UserCircleIcon class="md:h-12 md:w-12 sm:h-8 sm:w-8 h-6 w-6"/>
            <span class="text-xs text-gray-300 md:text-sm sm:text-xs">Musisi Abubakr</span>
            <span class="hidden md:block sm:block text-gray-300 md:text-sm sm:text-xs">UBF 232F</span>
        </div>
    </div>
